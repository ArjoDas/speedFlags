...
const gameFunc = {
    ...
    async firstFlag() {
        ...
        try {
            let svgData = await apiCallFunctions.getFirstSvg(); // Changed to use apiCallFunctions
    ...
    endGame() {
        ...
        gameStats.endTime = 0; // Changed from endTime to gameStats.endTime
        mainElements.infoBoard.innerHTML = `
    ...
    feedback(right, correctAns){
        ...
        setTimeout(() => {
            mainElements.feedbackParent.innerHTML = ``; // Changed from assignment to innerHTML
        }, 400);
    }
}
...
document.addEventListener('DOMContentLoaded', async() => {
    ...
    mainElements.input.addEventListener('keydown', async (event) => {
        ...
        } else if (latestChar === 'ArrowDown'){
            // TODO: Implement selecting the option below
    
        } else if (latestChar === 'ArrowUp') {
            // TODO: Implement selecting the option above
            ...
            mainElements.durationInputs.forEach(input => {
                input.addEventListener('change', function(){
                    if (this.checked) {
                        ...
                        // TODO: Implement API call to check whether duration is allowed
                        mainElements.initialDurationDisplay.textContent = `${duration} seconds!`
                        gameStats.duration = duration * 1000; // Convert seconds to milliseconds
                    }
                })
            })
        }
            ...
            mainElements.incrementInputs.forEach(input => {
                input.addEventListener('change', function(){
                    if (this.checked) {
                        ...
                        gameStats.increment = increment * 1000; // Convert seconds to milliseconds
                    }
                })
            })
        }
    ...
    // TODO: Implement difficulty modes
    // TODO: Implement prevention of flag repetition
    // TODO: Complete the autocomplete functionality (arrow key navigation)
    // TODO: Polish the user interface
    // TODO: Implement the "+5s" feature (using gameStats.increment)
    // TODO: Refactor code to be more object-oriented
    // TODO: Add comprehensive error handling
    // TODO: Implement game state management (e.g., pausing, resuming)
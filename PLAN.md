...
Sharing copies only five rows of six outcome blocks (green correct, red incorrect, yellow skipped), followed immediately on the next line by adjusted total time (no blank line). The results screen separately shows e.g. “2:12 · 24/30” and “1:42 + 30s penalties”. Incomplete/expired rounds cannot produce a completed share. Finishing all 30 is mandatory for a result.

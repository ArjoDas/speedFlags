...
The 250 original entities are countries **and territories**, not a sovereignty list. The introductory deck has 50 curated entries; the full deck has 246 distinct assets. Shared flag questions accept all associated names: France / Saint Martin; Norway / Bouvet Island / Svalbard and Jan Mayen; United States / US Minor Outlying Islands. Official names and explicit aliases are also accepted. Similar but different designs are not automatically merged.
